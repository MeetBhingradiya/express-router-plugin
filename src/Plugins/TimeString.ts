...
function parseTimestring (value:any, returnUnit?:any, opts?:any) {
...
function getSeconds (value:any, unit:any, unitValues:any) {
...
function convert (value:any, unit:any, unitValues:any) {
  return value / unitValues[getUnitKey(unit)]
}